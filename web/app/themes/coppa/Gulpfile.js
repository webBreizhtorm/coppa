...
var proxy = "http://localhost:8888/coppa/splash";
...
var paths = {
	src: {
		scripts: [
			...
			'./app/assets/scripts/lib/tarteaucitron/*.js',
			'./app/assets/scripts/lib/tarteaucitron/lang/*.js',
			'./app/assets/scripts/*.js'
		],
		styles: [
			'./app/assets/styles/normalize.min.css',
			'./app/assets/scripts/lib/tarteaucitron/css/*.css',
