...
add_action( 'wpcf7_init', 'fowl_wpcf7_add_form_tag_submit' );

function fowl_wpcf7_add_form_tag_submit() {
	wpcf7_add_form_tag( 'submit', 'fowl_wpcf7_submit_form_tag_handler' );
}

function fowl_wpcf7_submit_form_tag_handler( $tag ) {
	...
	$html = sprintf( '<button %1$s><span>'.$value.'</span></button>', $atts );
...
add_action( 'wpcf7_admin_init', 'fowl_wpcf7_add_tag_generator_submit', 55 );
